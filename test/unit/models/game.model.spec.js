...
// const QM = require('../../../src/opt/nodejs/models/questions.model')
...
//     this.beforeAll(() => {
//         dynamodbConnectorStub = sinon.stub(DBC.DynamoDbConnector.prototype, "connector").returns(mockConnector)
//         generateQuestionStub = sinon.stub(QM.QuestionsModel.prototype, "generateQuize")
//     })
